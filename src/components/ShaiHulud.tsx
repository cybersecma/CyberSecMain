      ...
      <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-8 backdrop-blur-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">
            Enter a GitHub username, profile URL, or organization name to check against our intelligence database.
          </p>
        </div>
        ...
        <form onSubmit={handleCheck} className="relative mb-8">
          <div className="relative">
            ...
            <input
              ...
              placeholder="e.g., https://github.com/username or @company"
        ...
        {status === 'pawned' && (
          <div className="bg-red-500/10 border border-red-500/50 rounded-lg p-6 flex items-start animate-fade-in">
            ...
            <div>
              <h3 className="text-xl font-bold text-red-500 mb-2">MATCH FOUND IN DATABASE</h3>
              <p className="text-gray-300">
                The identifier <span className="font-mono text-white bg-red-500/20 px-2 py-0.5 rounded">{input}</span> has been found in our leaked database records.
              </p>
            </div>
          </div>
        )}
        ...
        {status === 'safe' && (
          <div className="bg-green-500/10 border border-green-500/50 rounded-lg p-6 flex items-start animate-fade-in">
